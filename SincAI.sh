...
wget github.com/TunnelPro/sinc/raw/main/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget github.com/TunnelPro/sinc/raw/main/sincarm/sshplus.zip.002 > /dev/null 2>&1
wget github.com/TunnelPro/sinc/raw/main/sincarm/sshplus.zip.003 > /dev/null 2>&1
